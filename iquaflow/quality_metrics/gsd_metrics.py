...
class GSDMetrics(QualityMetrics):
    def __init__(self) -> None:
        ...
        cfg_path = os.path.join(current_path, "cfgs_example/config_scale.cfg")
        ...
        if not os.path.exists(self.regressor.checkpoint_path):
            checkpoint_url = "https://image-quality-framework.s3.eu-west-1.amazonaws.com/iq-tool-box/models/regressor/metrics_jun/checkpoint_scale.pth"
