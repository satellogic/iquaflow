...
class NoiseSharpnessMetrics(QualityMetrics):
    def __init__(
        ...
        checkpoint_url: str = "https://image-quality-framework.s3.eu-west-1.amazonaws.com/iq-tool-box/models/regressor/metrics_jun/checkpoint_sharpness_epoch133.pth",
    ) -> None:
