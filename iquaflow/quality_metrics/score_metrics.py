    ...
    def __init__(
        ...
        if default_checkpoint_urls is None:
            default_checkpoint_urls = [
                ...
                "https://image-quality-framework.s3.eu-west-1.amazonaws.com/iq-tool-box/models/regressor/training-results-whole/scale/test_AerialImageDataset_batchsize8_lr0.001_weightdecay1e-05_numregs10_scale_epochs200_numcrops10_splits0.445-0.112_inputsize1024-1024_momentum0.9_softthreshold0.3/checkpoint_epoch0.pth",
